...
```{r two_variables_plot}
ggplot(train, aes(x=total_sulfur_dioxide, y=density))+geom_point(aes(colour=factor(type))) + scale_color_manual(values=c("red","blue"))
```

## TODO

- Decir que podemos usar a) modelo más simple con 2 variables y 95% o b) modelo con 5 variables que tienen el mismo accuracy que el que tiene todas las variables.
